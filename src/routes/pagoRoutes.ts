...
pagoRouter.post('/', (req: Request, res: Response) => {pagoController.create(req, res)});
pagoRouter.put('/:id', (req: Request, res: Response) => {pagoController.update(req, res)});
pagoRouter.delete('/:id', (req: Request, res: Response) => {pagoController.remove(req, res)});
