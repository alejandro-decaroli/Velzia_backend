...
costoVariableRouter.get('/', (req: Request, res: Response) => {costoVariableController.getAll(req, res)});
costoVariableRouter.get('/:id', (req: Request, res: Response) => {costoVariableController.getById(req, res)});
costoVariableRouter.post('/create', (req: Request, res: Response) => {costoVariableController.create(req, res)});
